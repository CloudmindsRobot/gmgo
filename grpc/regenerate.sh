...
mkdir -p ${WORKDIR}/out/github.com/CloudmindsRobot/gmgo/grpc/balancer/rls/internal/proto/grpc_lookup_v1
mv ${WORKDIR}/out/github.com/CloudmindsRobot/gmgo/grpc/lookup/grpc_lookup_v1/* ${WORKDIR}/out/github.com/CloudmindsRobot/gmgo/grpc/balancer/rls/internal/proto/grpc_lookup_v1

# grpc_testingv3/testv3.pb.go is not re-generated because it was
# intentionally generated by an older version of protoc-gen-go.
rm ${WORKDIR}/out/github.com/CloudmindsRobot/gmgo/grpc/reflection/grpc_testingv3/*.pb.go
...
mkdir -p ${WORKDIR}/out/github.com/CloudmindsRobot/gmgo/grpc/credentials/tls/certprovider/meshca/internal/v1/
mv ${WORKDIR}/out/istio/google/security/meshca/v1/* ${WORKDIR}/out/github.com/CloudmindsRobot/gmgo/grpc/credentials/tls/certprovider/meshca/internal/v1/

cp -R ${WORKDIR}/out/github.com/CloudmindsRobot/gmgo/grpc/* .
