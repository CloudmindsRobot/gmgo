...
func TestOmitHTTP2(t *testing.T) {
	...
	out, err := exec.Command(goTool, "test", "-short", "-tags=nethttpomithttp2", "github.com/CloudmindsRobot/gmgo/net/http").CombinedOutput()
	if err != nil {
...
func TestOmitHTTP2Vet(t *testing.T) {
	t.Parallel()
	goTool := testenv.GoToolPath(t)
	out, err := exec.Command(goTool, "vet", "-tags=nethttpomithttp2", "github.com/CloudmindsRobot/gmgo/net/http").CombinedOutput()
	if err != nil {
